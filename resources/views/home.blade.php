    ...
    <div class="max-w-[88%] mx-auto px-6">
        <div class="flex items-center justify-between py-4">
            ...
            <ul id="navLinks" class="hidden sm:flex flex-row items-center gap-8 text-[20px] text-black order-1">
                ...
                <li>
                    <a href="{{ route('about') }}"
                       class="nav-link hover:text-[#4761FF] transition-all duration-300 relative group">
                        About
                        <span
                            class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#4761FF] transition-all duration-300 group-hover:w-full"></span>
                    </a>
                ...
                <li class="relative group">
                    <button
                        class="nav-link flex items-center gap-1 hover:text-[#4761FF] transition-all duration-300 relative group">
                        Service
                        <span
                            class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#4761FF] transition-all duration-300 group-hover:w-full"></span>
        ...
        <div id="mobileNavPanel"
            ...
            <ul class="flex flex-col gap-3 text-[18px] text-black">
                ...
                <li class="pt-2">
                    <a href="{{ route('quote') }}"
                       class="block text-center bg-[#4761FF] text-white font-medium px-4 py-2 rounded-full">Get A
                        Quote</a>
                </li>
            </ul>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14">
            ...
            <div>
                ...
                <ul class="space-y-2 text-[17px] text-[#B0B9AE]">
                    ...
                    <li><a href="#" class="hover:text-white duration-300 hover:text-[18px]"><i
                    ...
                    <li><a href="#" class="hover:text-white duration-300 hover:text-[18px]"><i
                                class="fa-solid fa-angle-right mr-3"></i>Terms & Condition</a></li>

                    <li><a href="#" class="hover:text-white duration-300 hover:text-[18px]"><i
                                class="fa-solid fa-angle-right mr-3"></i>Support</a></li>
