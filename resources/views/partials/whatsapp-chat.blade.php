        ...
        <a href="{{ $whatsappUrl }}"
           ...
           aria-label="Chat with us on WhatsApp">
            <span class="whatsapp-chat__bubble">
                ...
                @endphp
                @if (str_contains(strtolower($label), 'chat with us'))
                    <span class="whatsapp-chat__label-muted">{{ trim(str_ireplace('Chat with us', '', $label)) }}</span>
            ...
            <span class="whatsapp-chat__button" aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="whatsapp-chat__icon" fill="currentColor">
