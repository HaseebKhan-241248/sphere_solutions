...
--}}
            ...
            <!-- Action Button -->
            <a href="{{ route('quote') }}" data-aos="fade-down" data-aos-delay="650" class="hidden sm:inline-block bg-[#4761FF] hover:bg-indigo-700 text-white text-md font-medium px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 order-3">
                Hire Us
            </a>
        ...
        <div id="mobileNavPanel" class="hidden sm:hidden absolute left-0 top-full w-full bg-white shadow-lg z-50 px-6 py-4">
            <ul class="flex flex-col gap-3 text-[18px] text-black">
                <li><a href="{{ route('home') }}" class="block py-2 {{ request()->routeIs('home') ? 'text-[#4761FF]' : 'hover:text-[#4761FF]' }}">Home</a>
                </li>
