    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14">
      ...
      <div>
        ...
        <div class="flex gap-4 mt-4">
          ...
          <a href="https://x.com/SpMarkSolutions" target="_blank" rel="noopener" class="size-9 rounded-full bg-white text-black flex items-center justify-center hover:bg-[#4761FF] hover:text-white duration-300">
      ...
      <div>
        ...
        <form action="#" method="POST" class="relative">
          ...
          <button type="submit" class="absolute right-2 top-1/2 -translate-y-1/2 bg-white text-black px-6 h-12 rounded-lg text-[20px] hover:bg-[#4761FF] hover:text-white duration-300">
            SignUp
          </button>
        </form>
