        ...
        <div class="flex flex-col lg:flex-row items-center justify-between py-4 gap-4">
            ...
            <div class="flex flex-wrap items-center justify-center lg:justify-end gap-6 text-sm">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a style="font-weight: 500;" href="https://www.facebook.com/profile.php?id=61558581241296
                    ...
                    <a style="font-weight: 500;" href="https://x.com/SpMarkSolutions
                       class="size-7.5 rounded-full bg-white text-[#4761FF] flex items-center justify-center hover:bg-gray-200 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    ...
                    <a style="font-weight: 500;" href="https://www.linkedin.com/in/sm-solutions/
                       class="size-7.5 rounded-full bg-white text-[#4761FF] flex items-center justify-center hover:bg-gray-200 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-current" viewBox="0 0 24 24">
    ...
    <div class="max-w-[88%] mx-auto px-6">
        <div class="flex items-center justify-between py-4">
            ...
            <ul id="navLinks" class="hidden sm:flex flex-row items-center gap-8 text-[20px] text-black order-1">
                <li>
                    <a href="#"
                       class="nav-link text-[#4761FF] hover:text-[#4761FF] transition-all duration-300 relative group">
                        Home
                ...
                <li>
                    <a href="#" class="nav-link hover:text-[#4761FF] transition-all duration-300 relative group">
                        About
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#4761FF] transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </li>
                ...
                <li class="relative group">
                    ...
                    <ul class="absolute left-0 top-full mt-2 w-40 bg-white shadow-lg rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 transform translate-y-2 group-hover:translate-y-0">
                        <li><a href="#"
                               class="block p-2 text-[15px] hover:text-[#4761FF] hover:bg-gray-50 transition-all duration-300">Web
                            Development</a></li>
                        <li><a href="#"
                ...
                <li class="relative group">
                    ...
                    <ul class="absolute left-0 top-full mt-2 w-40 bg-white shadow-lg rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 transform translate-y-2 group-hover:translate-y-0">
                        ...
                        <li><a href="#"
                               class="block p-2 text-[15px] hover:text-[#4761FF] hover:bg-gray-50 transition-all duration-300">404
                            Page</a></li>
                    </ul>
                </li>
        ...
        <div id="mobileNavPanel"
            ...
            <ul class="flex flex-col gap-3 text-[18px] text-black">
                <li><a href="#" class="block py-2 text-[#4761FF]">Home</a></li>
                ...
                <li class="pt-2">
                    <a href="#" class="block text-center bg-[#4761FF] text-white font-medium px-4 py-2 rounded-full">Get
                        A Quote</a>
                </li>
            </ul>
        </div>
    ...
    <div class="max-w-[85%] mx-auto grid lg:grid-cols-3 gap-12">
        ...
        <aside class="space-y-8">
            <div class="shadow-[0_0_15px_5px_rgba(0,0,0,0.1)] p-5 rounded-lg">
                <div class="relative ">
                    <input type="text" placeholder="Search..."
                           class="w-full h-14 rounded-xl border border-gray-300 px-5 pr-14 text-[17px] outline-none focus:border-[#4761FF]">
            ...
            <div>
                ...
                <div class="bg-white rounded-lg shadow-[0_0_15px_5px_rgba(0,0,0,0.06)] p-5 space-y-3">
                    <a href="#"
                       class="flex items-center justify-between border-l-4 border-gray-300 py-3 px-7 rounded-lg  hover:text-[#4761FF] transition font-bold text-[17px] shadow-[0_0_4px_rgba(0,0,0,0.15)] text-[#20233F]">
                        Digital Marketing
            ...
            <div>
                ...
                <form class="bg-white rounded-lg shadow-[0_0_15px_5px_rgba(0,0,0,0.06)] p-6 space-y-4">
                    ...
                    <input type="email" placeholder="Your Email"
                           class="w-full h-14 rounded-xl border border-gray-300 px-5 text-[16px] outline-none focus:border-[#4761FF]">
                    ...
                    <textarea rows="4" placeholder="Message"
                              class="w-full rounded-xl border border-gray-300 px-5 py-3 text-[16px] outline-none focus:border-[#4761FF]"></textarea>
                    <button type="button"
                            class="w-full h-14 rounded-xl text-white text-lg bg-linear-to-r from-[#4761FF] to-[#5C6CFF] hover:opacity-90 duration-300">
                        Submit Now
                    </button>
                </form>
            </div>
            ...
            <div class="bg-white shadow-[0_0_15px_5px_rgba(0,0,0,0.1)]  rounded-lg p-8 text-center">
                ...
                <a href="#"
                   class="inline-block bg-[#4761FF] hover:bg-indigo-700 text-white font-medium px-8 py-4 rounded-lg transition">
                    Let's work together
                </a>
            </div>
...
<footer class="bg-[#1C2035] text-white">
    ...
    <div class="max-w-[88%] mx-auto py-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-center gap-4 text-[17px] text-[#B0B9AE]"><i
                            class="fa-solid fa-location-dot"></i><span>Vancouver, BC, Canada</span></li>
                    <li class="flex items-center gap-4 text-[17px] text-[#B0B9AE]"><i
                            class="fa-solid fa-phone"></i><span>+1 (604) 313-7091</span></li>
                    <li class="flex items-center gap-4 text-[17px] text-[#B0B9AE]"><i
                            class="fa-solid fa-envelope"></i><span>info@spheremarketingsolutions.com</span></li>
                </ul>
                <div class="flex gap-4 mt-4">
                    <a href="#"
                       class="size-9 rounded-full bg-white text-black flex items-center justify-center hover:bg-[#4761FF] hover:text-white duration-300"><i
            ...
            <div>
                ...
                <ul class="space-y-2 text-[17px] text-[#B0B9AE]">
                    <li><a href="#" class="hover:text-white duration-300"><i class="fa-solid fa-angle-right mr-3"></i>About
                        Us</a></li>
                    <li><a href="#" class="hover:text-white duration-300"><i class="fa-solid fa-angle-right mr-3"></i>Contact
                        Us</a></li>
                    <li><a href="#" class="hover:text-white duration-300"><i class="fa-solid fa-angle-right mr-3"></i>Our
                        Services</a></li>
                    <li><a href="#" class="hover:text-white duration-300"><i class="fa-solid fa-angle-right mr-3"></i>Terms
                        & Condition</a></li>
                    <li><a href="#" class="hover:text-white duration-300"><i class="fa-solid fa-angle-right mr-3"></i>Support</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-2">
                    <div><p class="text-[17px] text-[#B0B9AE]">Monday - Friday</p><h4 class="text-[18px] font-semibold">
                        09:00 am - 06:00 pm</h4></div>
                    <div><p class="text-[17px] text-[#B0B9AE]">Saturday</p><h4 class="text-[18px] font-semibold">09:00
                        am - 12:00 pm</h4></div>
                    <div><p class="text-[17px] text-[#B0B9AE]">Sunday</p><h4 class="text-[18px] font-semibold">
                        Closed</h4></div>
                </div>
            </div>
    ...
    <div class="bg-black">
        <div class="max-w-[88%] mx-auto py-7 flex flex-col md:flex-row items-center justify-between gap-5">
            <p class="text-[17px] text-gray-300">© <span class="font-semibold text-white">Sphere Marketing Solutions</span>,<span
                    class="text-[#B0B9AE]"> All Right Reserved.</span></p>
            <p class="text-[17px] text-gray-300"><span class="text-[#B0B9AE]">Sphere Digital Marketing Solutions</span></p>
        </div>
    </div>
