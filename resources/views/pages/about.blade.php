...
<section>
    ...
    <div class="bg-slate-50 py-24 px-4 sm:px-6 lg:px-8">
        <div class="max-w-[85%] mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-xs border border-slate-100 p-8 hover:shadow-md transition duration-300">
...
<section class="relative w-full bg-slate-50 overflow-hidden">
    ...
    <div class="relative min-h-[650px] lg:min-h-[700px] xl:min-h-[750px] w-full flex items-end lg:items-end overflow-hidden">
        ...
        <div class="absolute inset-0 z-20 flex items-center justify-center lg:justify-start lg:pl-62">
            <button class="w-20 h-20 lg:w-24 lg:h-24 bg-[#4761FF] text-white rounded-full flex items-center justify-center shadow-2xl transition duration-300 transform hover:scale-110 relative group focus:outline-none">
        ...
        <div class="relative z-20 w-full lg:w-[45%] lg:ml-auto bg-white p-6 sm:p-10 shadow-2xl
                    ...
                    max-h-[85vh] overflow-y-auto bottom-0 self-end">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                ...
                <div class="flex flex-col items-start">
                    <div class="mb-3">
                        <img src="{{ asset('images/icon-2.png') }}" alt="Expert Icon" class="w-12 h-12 object-contain">
                    </div>
